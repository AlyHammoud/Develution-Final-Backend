...
Route::get('newestProducts', [ProductsController::class, 'newestProducts'])->name('products.newest');
Route::get('/mostViewedProducts', [SiteDataController::class, 'getMostViewedProducts'])->name('siteData.mostViewedProducts');
Route::get('/mostViewedProductsByCategory', [SiteDataController::class, 'getMostViewedProductsByCategory'])->name('siteData.mostViewedProductsByCategory');
//
// End Products
//


Route::post('/add-new-ad', [AdsController::class, 'store']);
Route::get('/get-all-ad', [AdsController::class, 'index']);
Route::delete('/delete-ad/{ad}', [AdsController::class, 'destroy']);
